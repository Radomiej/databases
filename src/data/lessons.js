export const LESSONS = [
  ...
  },
  {
    ...
    task: 'Pokaż cztery pierwsze zamówienia razem z imieniem i nazwiskiem klienta oraz statusem.',
    hint: 'Połącz zamowienia z klienci przez z.klient_id = k.id i dodaj LIMIT 4.',
    solution: "SELECT z.id, k.imie || ' ' || k.nazwisko AS klient, z.status FROM zamowienia z INNER JOIN klienci k ON k.id = z.klient_id ORDER BY z.id LIMIT 4;",
    successMessage: 'Dobrze — dane z dwóch tabel są teraz w jednym raporcie.',
    expected: {
      columns: ['id', 'klient', 'status'],
