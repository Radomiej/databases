...
const LESSON_DEFINITIONS = [
  {
    ...
    difficulty: 'Start',
    theory: 'SELECT wybiera dane, które chcesz zobaczyć. Po słowie SELECT wpisujesz nazwy kolumn, a po FROM nazwę tabeli. LIMIT ogranicza liczbę zwracanych rekordów, więc przydaje się do szybkiego podglądu dużej tabeli.',
    ...
    expected: { columns: ['tytul'], rows: [['Pan Tadeusz'], ['Lalka'], ['Quo vadis']], strictOrder: false },
  },
  {
    id: 'where',
    order: 2,
    ...
    expected: { columns: ['tytul'], rows: [['Bieguni'], ['Solaris'], ['Krzyżacy']], strictOrder: false },
  },
  {
    id: 'order-by',
    order: 3,
  ...
  },
  {
    ...
    expected: { columns: ['czytelnik'], rows: [['Tomasz Zieliński']], strictOrder: false },
  },
  {
    id: 'aggregates',
    order: 5,
  ...
  },
  {
    ...
    task: 'Pokaż cztery zamówienia o najniższych identyfikatorach, w kolejności rosnącej. Uwzględnij imię i nazwisko klienta oraz status zamówienia.',
    hint: 'Połącz zamowienia z klienci przez z.klient_id = k.id, posortuj po z.id rosnąco i dodaj LIMIT 4.',
    solution: 'SELECT z.id, k.imie, k.nazwisko, z.status FROM zamowienia z INNER JOIN klienci k ON k.id = z.klient_id ORDER BY z.id ASC LIMIT 4;',
  ...
  },
  {
    ...
    task: 'Pokaż oceny z przedmiotu „Bazy danych”: imię i nazwisko ucznia, klasę, przedmiot oraz ocenę. Uporządkuj wynik rosnąco według identyfikatora ucznia.',
    hint: 'Połącz oceny z uczniami, klasami i przedmiotami. Ogranicz przedmiot przez WHERE p.nazwa = \'Bazy danych\' i posortuj wynik po identyfikatorze ucznia.',
  ...
  },
  {
    ...
    task: 'Pokaż uczniów, którzy otrzymali co najmniej jedną ocenę 5. Uporządkuj wynik rosnąco według identyfikatora ucznia.',
    hint: 'W podzapytaniu wybierz uczen_id z tabeli oceny dla rekordów z oceną 5, a na zewnątrz użyj IN.',
    solution: 'SELECT imie, nazwisko FROM uczniowie WHERE id IN (SELECT uczen_id FROM oceny WHERE ocena = 5) ORDER BY id;',
